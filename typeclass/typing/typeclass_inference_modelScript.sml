...
open typeclass_typingTheory typeclass_typingPropsTheory
     typeclass_tcexpTheory pure_configTheory pure_varsTheory typeclass_unificationTheory
     typeclass_inference_commonTheory typeclass_inferenceTheory typeclass_inferencePropsTheory
     pure_miscTheory pure_barendregtTheory;

val _ = new_theory "typeclass_inference_model";
