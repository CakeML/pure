...
[~Letrec_Lams_combine1:]
  (∀f g y1 y2 v1 v2 x1 x2 vL1 vL2 vL3 bL1 bL2 bL3 i.
     ...
     exp_rel (Letrec (SNOC (v1, Lams (vL3++vL2) (Apps x1
                                                 (MAP Var vL3 ++
...
Proof
  ...
  >- (gvs [freevars_Lams, freevars_def, freevars_Apps] >>
      rw [SET_EQ_SUBSET, SUBSET_DEF] >> gvs [MAP_SNOC]
      >- (gvs [freevars_Lams, freevars_Apps, freevars_def]
          >- (disj2_tac
              \\ ‘∀A B. A ⇒ A ∨ B’ by gvs [] \\ pop_assum $ irule_at Any
              \\ gvs [])
          >- gvs [MEM_MAP, freevars_def]
          >- (gvs [MEM_EL, EL_MAP, EL_MAP2]
              \\ qpat_x_assum ‘_ ∈ freevars _’ mp_tac \\ IF_CASES_TAC \\ gvs [freevars_def]
              \\ strip_tac \\ gvs []))
      >- (gvs [freevars_Lams, freevars_Apps, freevars_def]
          ...
          >- (gvs [MEM_EL, EL_MAP, EL_MAP2]
              ...
              \\ strip_tac \\ gvs []))
      >- (disj2_tac
          \\ ‘∀A B. B ⇒ A ∨ B’ by gvs [] \\ pop_assum $ irule_at Any
          \\ ‘∀A B. B ⇒ A ∨ B’ by gvs [] \\ pop_assum $ irule_at Any
...
Proof
  ...
  >~ [‘SNOC _ (SNOC _ _)’] >- (
    ...
    \\ rpt (‘∀e1 e2 l1 l2. e1 = e2 ∧ l1 = l2 ⇒ Lams l1 e1 = Lams l2 e2’ by gvs []
            \\ pop_assum $ irule_at Any)
    \\ gvs []
    \\ rpt (‘∀e1 e2 l1 l2. e1 = e2 ∧ l1 = l2 ⇒ Apps e1 l1 = Apps e2 l2’ by gvs []
            \\ pop_assum $ irule_at Any)
    \\ gvs []
    \\ gvs [GSYM FILTER_REVERSE, ALOOKUP_FILTER]
    \\ qpat_x_assum ‘LIST_REL (λb3 b2. b3 ⇒ b2) _ _’ $ irule_at Any
    \\ qpat_assum ‘ALL_DISTINCT (_ ++ _)’ $ irule_at Any \\ gvs []
    \\ qpat_assum ‘_ < LENGTH _’ $ irule_at Any \\ gvs [EVERY_MEM, freevars_subst]
    \\ rw [] \\ gvs []
    >- (‘∀l1 l2 l3 l4 : exp list. l1 = l2 ∧ l3 = l4 ⇒ l1 ++ l3 = l2 ++ l4’ by gvs []
        ...
        \\ drule_then assume_tac EL_MEM \\ gvs [MEM_FILTER] \\ gvs [MEM_EL, EL_ZIP])
    >- (‘∀l1 l2 l3 l4 : exp list. l1 = l2 ∧ l3 = l4 ⇒ l1 ++ l3 = l2 ++ l4’ by gvs []
        \\ pop_assum irule
        \\ conj_tac \\ irule LIST_EQ
        \\ rw [EL_MAP, EL_MAP2, subst_def, GSYM FILTER_REVERSE, ALOOKUP_FILTER, EL_MEM]
        \\ gvs [MEM_MAP] \\ first_x_assum $ resolve_then (Pos hd) assume_tac EQ_REFL
        \\ gvs [EL_MEM])
    >- (‘∀l1 l2 l3 l4 : exp list. l1 = l2 ∧ l3 = l4 ⇒ l1 ++ l3 = l2 ++ l4’ by gvs []
        \\ pop_assum irule
        \\ conj_tac \\ irule LIST_EQ
        ...
        \\ gvs [MEM_MAP] \\ first_x_assum $ resolve_then (Pos hd) assume_tac EQ_REFL
        \\ gvs [EL_MEM])
    >- (rename1 ‘subst _ y2 = _’ \\ rename1 ‘exp_rel x2 y2’
    ...
    >- (gvs [MEM_MAP, PULL_EXISTS]
        \\ last_x_assum $ dxrule_then assume_tac
        \\ pairarg_tac \\ gvs [ok_bind_subst])
    >- (gvs [MEM_MAP, PULL_EXISTS]
        \\ last_x_assum $ dxrule_then assume_tac
        \\ pairarg_tac \\ gvs [ok_bind_subst])
    >- (‘LENGTH f = LENGTH g’ by gvs [LIST_REL_EL_EQN]
        \\ rw [LIST_REL_EL_EQN, EL_MAP]
        \\ gvs [Once LIST_REL_EL_EQN, EL_MAP]
        \\ last_x_assum $ drule_then assume_tac
        \\ pairarg_tac \\ gs [] \\ pairarg_tac \\ gs []
        \\ first_x_assum irule
        \\ gvs [MAP_FST_FILTER, EVERY2_MAP]
        \\ qabbrev_tac ‘P = λn. n ≠ v1 ∧ n ≠ v2 ∧ ¬MEM n (MAP FST g)’ \\ gvs []
    ...
    >- (first_x_assum irule
        ...
        \\ first_x_assum $ irule_at Any \\ gvs [])
    >- (first_x_assum irule
        \\ gvs [MAP_FST_FILTER, EVERY2_MAP, FILTER_FILTER, LAMBDA_PROD, GSYM CONJ_ASSOC]
        \\ qabbrev_tac ‘P = λn. ¬MEM n (MAP SND (FILTER FST (ZIP (bL3, vL1)))) ∧ ¬ MEM n vL2 ∧
                                n ≠ v1 ∧ n ≠ v2 ∧ ¬MEM n (MAP FST g)’ \\ gvs []
        \\ irule LIST_REL_FILTER \\ gs []
        \\ irule LIST_REL_mono
        \\ first_x_assum $ irule_at Any \\ gvs []))
  >~ [‘SNOC _ (SNOC _ _)’] >- (
...
Proof
  ...
  Cases_on ‘eL = []’ >> gvs [FOLDL_SNOC, eval_to_def] >>
  rename1 ‘eval_to k x’ >>
  Cases_on ‘eval_to k x’ >>
  gvs [subst_funs_def, subst_empty, subst_def, eval_to_def, dest_anyClosure_def] >>
  IF_CASES_TAC >> gvs [] >>
  AP_TERM_TAC >> irule EQ_TRANS >> irule_at (Pos last) subst_commutes >>
  gvs [MAP_FST_FILTER, MEM_FILTER, subst_APPEND] >>
  irule EQ_TRANS >> irule_at (Pos hd) $ GSYM subst_remove >>
  Q.REFINE_EXISTS_TAC ‘{_}’ >> gvs [] >> irule_at Any EQ_REFL >>
  gvs [freevars_subst]
QED
...
Proof
  Induct using SNOC_INDUCT >> rw [] >>
  gvs [MAP_SNOC, FOLDL_SNOC] >>
  Cases_on ‘eL = []’ >> gvs [eval_to_def, dest_anyClosure_def]
QED
...
Proof
  Induct using SNOC_INDUCT \\ gvs [MAP_SNOC, FOLDL_SNOC]
  \\ gvs [eval_to_def] \\ rw []
  \\ gvs [subst_funs_def, subst_empty]
  \\ gvs [eval_to_def]
QED
...
Proof
    ...
    >- (print_tac "Closure 1/4"
        ...
        >- (gvs [subst_Apps, subst1_def]
           ...
           \\ ‘MAP (subst list) (MAP2 (λb e. if b then Force e else e)
            ...
            \\ gvs [] \\ impl_tac
            >- (irule exp_rel_Apps \\ gvs [LIST_REL_EL_EQN, EL_MAP, exp_rel_def]
                \\ gvs [Abbr ‘expr1’, Abbr ‘expr2’] \\ irule exp_rel_Apps
                \\ irule_at Any exp_rel_Apps \\ gs []
                \\ conj_tac
                >- (gvs [EVERY2_MAP, exp_rel_def]
                    \\ qspecl_then [‘λx y. v_rel (SND x) (SND y)’, ‘λx.x’]
                                   assume_tac $ GEN_ALL LIST_REL_FILTER
            ...
            >- (qexists_tac ‘0’
                ...
                >- (irule exp_rel_Apps \\ gvs [EVERY2_MAP, subst1_def, exp_rel_def]
                    ...
                    >- (gvs [subst_def, Abbr ‘list’, GSYM ZIP_APPEND, REVERSE_APPEND, ALOOKUP_APPEND]
                        ...
                        \\ rw [EL_MAP, subst1_def] \\ gvs [EL_MAP, exp_rel_def, eval_to_Value]
    ...
    >- (print_tac "Closure 3/4"
        ...
        >- (gvs [subst_Apps, subst1_def]
            ...
            >- (qexists_tac ‘0’
                ...
                \\ Cases_on ‘eval_to k g = INL Diverge’ \\ gs []
                \\ dxrule_then assume_tac eval_to_mono \\ gvs [] \\ pop_assum kall_tac
                \\ rename1 ‘exp_rel x1 x2’ \\ qspecl_then [‘x1’, ‘x2’] assume_tac exp_rel_freevars
                ...
                >- (irule exp_rel_Apps \\ gvs [EVERY2_MAP, subst1_def, exp_rel_def]
                    ...
                    \\ qmatch_goalsub_abbrev_tac ‘exp_rel (subst (FILTER _ list1) _)
                    ...
                    \\ gvs [DISJOINT_ALT]
                    \\ pop_assum kall_tac
                    \\ irule exp_rel_subst \\ gvs [Abbr ‘list1’, Abbr ‘list2’]
                    \\ conj_tac
                    >- gvs [MAP_MAP_o, combinTheory.o_DEF, LAMBDA_PROD, GSYM FST_THM]
        ...
        \\ gvs []
        \\ gvs [subst1_notin_frees, freevars_subst]
        \\ qpat_assum ‘exp_rel x1 x2’ $ irule_at Any
        ...
        >- (irule EQ_TRANS \\ irule_at (Pos hd) subst1_notin_frees
            ...
            \\ qspecl_then [‘x1’, ‘x2’] assume_tac exp_rel_freevars \\ gvs []
            \\ once_rewrite_tac [CONS_APPEND] \\ gvs [])
        >- (irule EQ_TRANS \\ irule_at (Pos hd) subst1_notin_frees
            \\ gvs [GSYM CONJ_ASSOC, freevars_subst]
            \\ first_x_assum $ qspec_then ‘h’ assume_tac \\ gvs []
    ...
    >- (print_tac "Recclosure 2/3"
        ...
        >- (gvs [subst_Lams]
            ...
            >- (Cases_on ‘vL2’ \\ gvs []
                ...
                \\ irule v_rel_Closure \\ irule exp_rel_Lams \\ gvs []
                \\ gvs [FILTER_FILTER, LAMBDA_PROD]
                ...
                >- (irule exp_rel_Apps \\ gvs [LIST_REL_EL_EQN, EL_MAP2, EL_MAP]
                    \\ rw [] \\ rename1 ‘n < SUC (LENGTH _)’
                    \\ gvs [exp_rel_def]
                    \\ Cases_on ‘n’ \\ gvs [EL_MAP, exp_rel_def])
            ...
            >- (gvs [MAP_MAP_o, combinTheory.o_DEF, LAMBDA_PROD, GSYM FST_THM, MAP_FST_FILTER]
                ...
                \\ metis_tac [CONJ_COMM])
            >- (irule exp_rel_Apps \\ gvs [exp_rel_def]
            ...
            >- (gvs [FILTER_FILTER, LAMBDA_PROD, EVERY2_MAP]
                ...
                >- (gvs [LIST_REL_EL_EQN, EL_MAP] \\ rw []
                    ...
                    \\ ‘EL n (MAP FST xs) = EL n (MAP FST ys)’ by gvs [] \\ gvs [EL_MAP]
                    \\ gvs [v_rel_def] \\ disj2_tac \\ disj1_tac
                    \\ qpat_x_assum ‘exp_rel x1 x2’ $ irule_at Any
        ...
        >- (gvs [subst_Lams]
            ...
            >- (gvs [GSYM LAMBDA_PROD, FILTER_T]
                ...
                \\ qmatch_goalsub_abbrev_tac ‘eval_to _ (Apps (Value (Recclosure _ _)) list1')’
                \\ qspecl_then [‘list1'’, ‘k-1’, ‘list1’, ‘v1'’] mp_tac
                               eval_to_Apps_Recclosure_Lams_not_0
                \\ ‘list1' ≠ []’ by gvs [Abbr ‘list1'’] \\ gvs []
                \\ pop_assum kall_tac
                \\ gvs [Abbr ‘list1’, REVERSE_APPEND]
                \\ qmatch_goalsub_abbrev_tac ‘Apps (Tick (subst_funs list1 _)) _’
                \\ disch_then kall_tac
                \\ gvs [subst_funs_def, subst_def, subst_Lams]
                \\ Cases_on ‘i’ \\ gvs []
                \\ Cases_on ‘vL2’
                \\ gvs [GSYM LAMBDA_PROD, FILTER_T, Abbr ‘list1'’,
                ...
                >- (conj_tac
                    ...
                    >- gvs [MAP_MAP_o, combinTheory.o_DEF, LAMBDA_PROD, GSYM FST_THM]
                    >- (once_rewrite_tac [CONS_APPEND] \\ gvs [subst_APPEND]
                        \\ irule exp_rel_subst \\ irule_at Any exp_rel_subst
                        \\ last_x_assum $ qspec_then ‘0’ assume_tac \\ gvs [exp_rel_subst]
                        \\ conj_tac \\ gvs [v_rel_def] \\ disj2_tac \\ disj1_tac
                        \\ qpat_x_assum ‘exp_rel x1 x2’ $ irule_at Any
                        \\ Q.REFINE_EXISTS_TAC ‘[_]’ \\ gvs []
                        \\ qpat_assum ‘_ ∉ freevars x1’ $ irule_at Any
                        \\ Q.REFINE_EXISTS_TAC ‘[_]’ \\ gvs []
                        \\ qexists_tac ‘0’ \\ qexists_tac ‘[F]’ \\ gvs []
                        \\ qexists_tac ‘[F]’ \\ gvs []
                        \\ Cases \\ gvs [])
                    >- (gvs [LIST_REL_EL_EQN, EL_MAP] \\ rw []
                        \\ rename1 ‘n < _’
            ...
            >- (gvs [GSYM LAMBDA_PROD, FILTER_T]
                ...
                >- (conj_tac
                    >- (once_rewrite_tac [eval_to_def]
                        ...
                        \\ gvs [subst_APPEND])
                    \\ gvs [exp_rel_def]
                    \\ gvs [Abbr ‘expr1’, Abbr ‘expr2’] \\ gvs [exp_rel_def]
                    \\ ‘∀l h2. subst1 h2 v1 (subst (FILTER (λ(n,x). n ≠ h2) l) x1)
                               = subst l (subst1 h2 v1 x1)’
                      by (gen_tac \\ gen_tac \\ irule EQ_TRANS
                          \\ irule_at (Pos hd) subst_commutes
  ...
  >~ [‘Letrec f x’] >- (
    ...
    >- (IF_CASES_TAC \\ gs []
        ...
        \\ last_x_assum $ qspec_then ‘k - 1’ assume_tac \\ gvs []
        \\ pop_assum irule \\ gvs []
        \\ gvs [subst_funs_def, SNOC_APPEND, MAP_APPEND, subst_APPEND] \\ irule exp_rel_subst
        \\ rw []
        >- gvs [MAP_MAP_o, combinTheory.o_DEF, LAMBDA_PROD, GSYM FST_THM]
        >- (once_rewrite_tac [CONS_APPEND] \\ gvs [subst_APPEND]
            \\ irule exp_rel_subst \\ gvs []
  ...
  >~ [‘Force x’] >- (
    ...
    >- (
      ...
      >- (gvs [dest_anyThunk_def, v_rel_def, REVERSE_APPEND, REVERSE_SNOC]
          ...
          \\ rename1 ‘subst_funs _ x3’ \\ rename1 ‘exp_rel x3 y3’
...
Proof
  ...
  >- (Cases_on ‘vL2 = []’ \\ gvs [REVERSE_APPEND]
      ...
      >- (first_x_assum irule
          ...
          >- (irule exp_rel_Lams \\ irule exp_rel_Apps
              \\ gvs [LIST_REL_EL_EQN, EL_APPEND_EQN, EL_MAP, EL_MAP2, exp_rel_def]
              \\ rw [exp_rel_def])
      ...
      >- (first_x_assum irule \\ fs []
          ...
          >- (Cases_on ‘bL2’ \\ gvs [] \\ Cases_on ‘vL2’ \\ gvs [subst_def, GSYM LAMBDA_PROD, FILTER_T]
              ...
              \\ conj_tac >- (strip_tac \\ gvs [])
              \\ gvs [exp_rel_def]
              \\ irule exp_rel_subst \\ gvs [MAP_MAP_o, combinTheory.o_DEF, LAMBDA_PROD, GSYM FST_THM]
              \\ conj_tac
  ...
  >- (Cases_on ‘vL2 = []’ \\ gvs [REVERSE_APPEND]
      ...
      >- (first_x_assum irule \\ fs []
          ...
          >- (Cases_on ‘bL2’ \\ gvs [] \\ Cases_on ‘vL2’ \\ gvs [subst_def, GSYM LAMBDA_PROD, FILTER_T]
              ...
              \\ irule exp_rel_subst \\ gvs [MAP_MAP_o, combinTheory.o_DEF, LAMBDA_PROD, GSYM FST_THM]
              \\ conj_tac
              >- (irule exp_rel_subst \\ gvs [v_rel_def] \\ disj2_tac \\ disj2_tac
                  \\ qpat_x_assum ‘exp_rel _ _ ’ $ irule_at Any
                  \\ rename1 ‘Lam h (App (Var v1) (Var h))’
                  \\ qexists_tac ‘[h]’ \\ Q.REFINE_EXISTS_TAC ‘[_]’ \\ gvs []
                  \\ qexists_tac ‘0’ \\ qexists_tac ‘[F]’ \\ qexists_tac ‘[F]’ \\ gvs []
