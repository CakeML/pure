...
Proof
  ...
  >~ [‘Update’] >-
   (gvs [application_def,step,step_res_rel_cases]
    ...
    \\ simp [Once v_rel_cases,LIST_REL_EL_EQN,state_rel_def])
  >~ [‘AllocMutThunk’] >-
   (gvs [application_def,step,step_res_rel_cases, OPTREL_def]
  ...
  >~ [‘UpdateMutThunk’] >-
   (gvs [application_def,step,step_res_rel_cases]
    ...
    \\ simp [Once v_rel_cases]
    \\ gvs [AllCaseEqs(),oEL_THM,state_rel_def,LIST_REL_EL_EQN] \\ rw [])
  >~ [‘ForceMutThunk’] >-
  ...
  >~ [‘ForceMutK’] >-
   (qrefine ‘SUC ck’ \\ gvs [ADD_CLAUSES, step_n_SUC, step]
    ...
    \\ (
      ...
      \\ rpt (TOP_CASE_TAC \\ gvs [])
      \\ last_x_assum drule \\ gvs [store_rel_def]))
  \\ rename [‘AppK’]
  \\ Q.REFINE_EXISTS_TAC ‘SUC ck’ \\ fs [ADD_CLAUSES,step_n_SUC,step]
