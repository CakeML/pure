-- nofib: imaginary/queens
-- PureLang port adapted from PureCake examples/queens.hs. Corresponds to the
-- nofib `queens` benchmark (imaginary subset). Counts the solutions to the
-- N-queens problem by brute force; the single command-line argument is the
-- board size N.
