-- nofib: imaginary/primes
-- PureLang port adapted from PureCake examples/primes.hs. Corresponds to the
-- nofib `primes` benchmark (imaginary subset). The single command-line argument
-- n selects the n-th prime (0-indexed), computed two ways: a lazy filtering
-- sieve and divisor testing.
