-- nofib: spectral/life
-- PureLang port adapted from PureCake examples/gameOfLife.hs. Corresponds to
-- the nofib `life` benchmark (Conway's Game of Life; orig. John Launchbury,
-- Glasgow). Steps a fixed 100x100 circuit (5 Gosper guns) for N generations,
-- where N is the single command-line argument, and prints the final board.
